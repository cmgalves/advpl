...
User Function MBValCnb()        // incluido pelo assistente de conversao do AP5 IDE em 31/05/00
	...
	IF SA1->A1_ZZTXBOL=="1"
		_ret := STRZERO((ROUND(SE1->(E1_SALDO-E1_SDDECRE+E1_SDACRES+nTaxa), 2)*100),13)
		//STRZERO(INT(SE1->(E1_SALDO-E1_SDDECRE+E1_SDACRES+nTaxa)*100),13)
	ELSE
		_ret := STRZERO((ROUND(SE1->(E1_SALDO-E1_SDDECRE+E1_SDACRES), 2)*100),13)
	ENDIF
