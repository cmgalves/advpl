...
Else
	...
	For nCount := 1 To Len( oNfe:_MDFE:_INFMDFE:_INFMODAL:_RODO:_VEICREBOQUE )
		If Type( 'oNfe:_MDFE:_INFMDFE:_INFMODAL:_RODO:_VEICREBOQUE[nCount]:_PLACA' ) <> 'U'
			oDamdfe:Say(nLinha, 0005, AllTrim(oNfe:_MDFE:_INFMDFE:_INFMODAL:_RODO:_VEICREBOQUE[nCount]:_PLACA:TEXT), oFont08)
		EndIf

		If Type( 'oNfe:_MDFE:_INFMDFE:_INFMODAL:_RODO:_VEICREBOQUE[nCount]:_PROP:_RNTRC' ) <> 'U'
			oDamdfe:Say(nLinha, 0155, AllTrim(oNfe:_MDFE:_INFMDFE:_INFMODAL:_RODO:_VEICREBOQUE[nCount]:_PROP:_RNTRC:TEXT), oFont08)
		EndIf
	...
	If Type("oNfe:_MDfe:_InfMDfe:_infDoc:_infMunDescarga") <> "U"
		If ValType(oNfe:_MDfe:_InfMDfe:_infDoc:_infMunDescarga)=="A"
			For nY := 1 to len(oNfe:_MDfe:_InfMDfe:_infDoc:_infMunDescarga)
				If ValType(oNfe:_MDfe:_InfMDfe:_infDoc:_infMunDescarga[nY]:_infNFe)=="A"
...
oDamdfe:Say(0098, 0005, 'CNPJ/CPF: ' + Transform(oCab:_MDFE:_INFMDFE:_EMIT:_CNPJ:TEXT,"@r 99.999.999/9999-99"), oFont08)
oDamdfe:Say(0098, 0110, 'IE: ' + oCab:_MDFE:_INFMDFE:_EMIT:_IE:TEXT, oFont08)	//CNPJ e IE
oDamdfe:Say(0098, 0190, 'RNTRC: ' + IIF(Type("oNfe:_MDFE:_INFMDFE:_INFMODAL:_RODO:_INFANTT:_RNTRC") <> "U", oNfe:_MDFE:_INFMDFE:_INFMODAL:_RODO:_INFANTT:_RNTRC:TEXT,""),oFont08)	//RNTRC da Empresa
